...
layout = html.Div(
    [   
        ...
        html.H4("Raw distribution based on their performance per participant"),
        ...
        dcc.Graph(id="cross_model_group_histogram"),
        dcc.Graph(id="cross_model_group_avg"),
        ...
        html.Label(id="cross_model_display_samples_selected"),
...
def update_cross_model_only_histo(color_var_name,mask_treatment,data=cross_exp_aggregated_results):
...
def update_cross_model_violins(vars_name,color_var_name,mask_treatment,data=cross_exp_aggregated_results):
...
@callback(
    Output('cross_model_store_selected_indices', 'data'),
...
@callback(
    ...
    Input('cross_model_store_selected_indices', 'data'),
