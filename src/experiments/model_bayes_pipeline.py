...
def run(sim_used:str = "original", dst_file_path:str|None = None):
    ...
    for participant_id in participant_indices:
        ...
        ## Training
        complete_model = BGNNFramework(my_module,device)
...
if __name__ == "__main__":
    run(sim_used="original",dst_file_path="src/experiments/results/model_bayes_pipeline_content-liking_edge-sim_epochs-10000.csv")